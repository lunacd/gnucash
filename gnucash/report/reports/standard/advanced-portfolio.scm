...
(define reportname (N_ "Advanced Portfolio NG"))
...
(define (table-add-stock-rows table accounts to-date
  ...
  (let ((from-date   (gnc:time64-start-day-time
    ...
    (gnc:html-document-set-title!
     document (string-append
               report-title
               (format #f " ~a - ~a " (qof-print-date from-date) (qof-print-date to-date))))
...
(gnc:define-report
 'version 1
 'report-guid "69fa957357664daba4601bcbb4a9beb2"
 'name reportname
